        ...
        <div class="container-fluid">
            <div id="content" class="mx-auto tm-content-container">
                <main>
                    ...
                    <c:forEach var="v" items="${v}">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 tm-catalog-item">
                            <div class="position-relative tm-thumbnail-container">
                                <img src="https://img.youtube.com/vi/${v.poster}/maxresdefault.jpg" alt="Image" class="img-fluid tm-catalog-item-img">    
                                <a href="./video?action=watch&idV=${v.id}" class="position-absolute tm-img-overlay">
                                    <i class="fas fa-play tm-overlay-icon"></i>
                                </a>
                            </div>    
                            <div class="p-4 tm-bg-gray tm-catalog-item-description">
                                <h3 class="tm-text-primary mb-3 tm-catalog-item-title">${v.title}</h3>
                    ...
                    <div>
                        <ul class="nav tm-paging-links d-flex justify-content-center">
                        <c:forEach varStatus="i" begin="1" end="${maxPage }" >
                       	 	<li class="nav-item ${currentPage == i.index ? 'active' : '' }"><a href="./HomeControler?page=${i.index}" class="nav-link tm-paging-link ">${i.index}</a></li>
                        </c:forEach>
